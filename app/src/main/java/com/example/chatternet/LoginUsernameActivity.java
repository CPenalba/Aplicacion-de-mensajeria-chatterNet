...
public class LoginUsernameActivity extends AppCompatActivity {
    ...
    void setUsername() {
        ...
        FirebaseUtil.currrentUserDetails().set(userModel).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
    ...
    void getUsername() {
        setInProgress(true);
        FirebaseUtil.currrentUserDetails().get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
